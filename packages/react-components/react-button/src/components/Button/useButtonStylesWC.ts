...
import { makeStyles2 } from './makeStyles2';
...
const [useRootStyles, rootCSS] = makeStyles2({
  // Base styles
  base: {
    alignItems: 'center',
    display: 'inline-flex',
...
const [useRootDisabledStyles, rootDisabledCSS] = makeStyles2({
  // Base styles
  base: {
...
const [useRootFocusStyles, rootFocusCSS] = makeStyles2({
...
const [useRootIconOnlyStyles, rootIconOnlyCSS] = makeStyles2({
  // Size variations
  small: {
...
const [useIconStyles, iconCSS] = makeStyles2({
  // Base styles
  base: {
    alignItems: 'center',
    display: 'inline-flex',
...
export const useButtonStylesWC_unstable = (state: ButtonState): ButtonState => {
